...
const simpsonsBox = document.createElement('div')
document.body.appendChild(simpsonsBox);
simpsonsBox.setAttribute('class', 'simpsons-box');
for (const simpson of simpsons) {
    const simpsonCard = document.createElement('div');
    const simpsonInfo = document.createElement('div');
...
const simpsonsBox2 = document.createElement('div');
simpsonsBox2.setAttribute('class', 'simpsons-box')
document.body.appendChild(simpsonsBox2);

for (const simpson of simpsons) {
    const simpsonCard2 = document.createElement('div');
    simpsonsBox2.append(simpsonCard2);
    const simpsonNamAge = document.createElement('h2');
...
for (const product of products) {
    document.write('<div class="product-card">');
        ...
        document.write(`<img src=${product.image} alt="Image of "${product.title} class="product-image"/>`)
    document.write('</div>');
